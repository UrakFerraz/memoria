...
var slides = _toConsumableArray(document.querySelectorAll('.areaJogo'));
...
var Tabuleiro = /*#__PURE__*/function () {
  ...
  _createClass(Tabuleiro, [{
    ...
    value: function randomizar() {
      var randArr = _toConsumableArray(new Set(emojis.sort(function () {
...
var nivelFacil = new Tabuleiro(2, facilContainer);
var nivelNormal = new Tabuleiro(4, normalContainer);
var nivelDificil = new Tabuleiro(8, dificilContainer);
...
function play() {
  ...
  function restartGame() {
    ...
    setTimeout(function () {
      _toConsumableArray(document.querySelectorAll('.card')).map(function (card) {
        return card.remove();
      });

      distribuirCartas();

      _toConsumableArray(document.querySelectorAll('.card')).forEach(function (el) {
